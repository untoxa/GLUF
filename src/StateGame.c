...
const MapInfoBanked_t levels[] = {
	...
	BANKED_MAP(level09, MUSIC_ENTERTAINER, TILESET_2),
	BANKED_MAP(level10, MUSIC_ENTERTAINER, TILESET_2),
	BANKED_MAP(level11, MUSIC_ENTERTAINER, TILESET_2),
	BANKED_MAP(level12, MUSIC_ENTERTAINER, TILESET_2),
	BANKED_MAP(level13, MUSIC_ENTERTAINER, TILESET_2),
	BANKED_MAP(level14, MUSIC_ENTERTAINER, TILESET_2),
	...
	BANKED_MAP(level21, MUSIC_ENTERTAINER, TILESET_4),
	BANKED_MAP(level22, MUSIC_ENTERTAINER, TILESET_4),
	BANKED_MAP(level23, MUSIC_ENTERTAINER, TILESET_4),
	BANKED_MAP(level24, MUSIC_ENTERTAINER, TILESET_4),
	BANKED_MAP(level25, MUSIC_ENTERTAINER, TILESET_4),
	LEVELS_END
};
